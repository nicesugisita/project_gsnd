...
from services.rag_service.collection import (
    _uses_okms_document_schema,
    _uses_gsnd_v7_schema,
    _uses_welfare_center_schema,
)
from services.rag_service.document import _build_okms_document_name
from services.rag_service.extraction import _LIFECYCLE_CONTENT_KEYWORDS
