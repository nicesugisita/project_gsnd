...
from core.exceptions import LLMServiceError, StreamingError
...
async def _call_llm_api_sync(
    ...
    try:
        ...
        if allow_context_retry and _is_context_length_error(response):
            ...
            return await _call_llm_api_sync(api_url, compact_payload, allow_context_retry=False, timeout=timeout)
...
async def call_llm_api(
    ...
    try:
        ...
        if stream:
            ...
            return await _call_llm_api_sync(api_endpoint, payload, timeout=timeout)
