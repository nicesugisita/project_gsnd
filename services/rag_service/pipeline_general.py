...
from mariner.queryset_okms import query_group_a_documents
from mariner.queryset_gov_okms import query_gov_okms_documents
from mariner.queryset_okms_fallback import query_group_a_fallback
from mariner.queryset_gsnd import query_GSND_general_documents
from .common import (
...
async def process_rag_general(
    ...
    try:
        ...
        if not gen_lifecycle and messages:
            from services.lifecycle_service import extract_lifecycle_from_history
